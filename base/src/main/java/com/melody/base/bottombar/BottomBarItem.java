package com.melody.base.bottombar;
...
public class BottomBarItem extends LinearLayout {
    ...
    private void initAttrs(TypedArray ta) {
        ...
        mTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_itemTextSize, SizeUtils.sp2px(mTextSize));
        ...
        mMarginTop = ta.getDimensionPixelSize(R.styleable.BottomBarItem_itemMarginTop, SizeUtils.dp2px(mMarginTop));
        ...
        mUnreadTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_unreadTextSize, SizeUtils.sp2px(mUnreadTextSize));
        ...
        mMsgTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_msgTextSize, SizeUtils.sp2px(mMsgTextSize));
     ...
     * 设置未读数
     *
     * @param unreadNum 小于等于{@link com.melody.base.bottombar.BottomBarItem#unreadNumThreshold}则隐藏，
     *                  大于0小于{@link com.melody.base.bottombar.BottomBarItem#unreadNumThreshold}则显示对应数字，
     *                  超过{@link com.melody.base.bottombar.BottomBarItem#unreadNumThreshold}
     *                  显示{@link com.melody.base.bottombar.BottomBarItem#unreadNumThreshold}+
     */
